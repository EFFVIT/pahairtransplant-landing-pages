  ...
  return (
    <div style={{ fontFamily: "var(--font-jost), 'Open Sans', sans-serif", color: TEXT, background: WHITE }}>
      ...
      <header style={{ background: WHITE, padding: '20px 64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxShadow: '0px 4px 22.7px 0px rgba(0,0,0,0.45)' }}>
        <img src="/logo-pa.webp" alt="Hair Restoration of Lehigh Valley" style={{ height: 64, width: 'auto' }} />
      ...
      <div style={{ background: PANEL, padding: '56px 48px', textAlign: 'center' }}>
        <h1 style={{ fontFamily: "var(--font-cormorant), Georgia, serif", fontWeight: 700, color: DARK, fontSize: 40, textTransform: 'uppercase' as const, margin: 0, lineHeight: 1.129 }}>Privacy Policy</h1>
      </div>

      {/* Content */}
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '56px 48px' }}>

        <Heading>Last Updated: 10/01/2025</Heading>

        <p style={P}>
          Thank you for choosing to be part of our community at Hair Restoration of Lehigh Valley. (&ldquo;company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <a href="mailto:info@pahairtransplant.com" style={{ color: DARK }}>info@pahairtransplant.com</a>.
        </p>
        <p style={P}>
          When you visit our website <a href="https://www.pahairtransplant.com" style={{ color: DARK }}>https://www.pahairtransplant.com</a> and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our websites and our services.
        </p>
        <p style={P}>
          This privacy policy applies to all information collected through our website (such as https://www.pahairtransplant.com) and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the &ldquo;Websites&rdquo;).
        </p>
        ...
        <Section title="4. Do We Use Cookies and Other Tracking Technologies?">
          ...
          <p style={PIN}>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our <a href="/cookie-policy" style={{ color: DARK }}>Cookie Policy</a>.</p>
        </Section>
        ...
        <Section title="11. How Can You Contact Us About This Policy?">
          <p style={PIN}>If you have questions or comments about this policy or any further questions or comments about us or our policies, you may email us at <a href="mailto:info@pahairtransplant.com" style={{ color: DARK }}>info@pahairtransplant.com</a> or by post to:</p>
          <address style={{ fontStyle: 'normal', color: TEXT, lineHeight: 1.9, marginTop: 12, fontSize: 15 }}>
            <strong>Lehigh valley</strong><br />
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section style={{ marginBottom: 40 }}>
      <h2 style={{ fontFamily: "var(--font-jost), sans-serif", fontWeight: 700, fontSize: 22, color: ORANGE, textTransform: 'uppercase' as const, marginBottom: 16 }}>
        {title}
      </h2>
...
function Sub({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 16 }}>
      <h3 style={{ fontFamily: "var(--font-jost), sans-serif", fontSize: 16, fontWeight: 600, color: '#2a2a34', marginBottom: 10, marginTop: 8 }}>{title}</h3>
