  ...
  return (
    <div style={{ fontFamily: "'Jost', 'Open Sans', sans-serif", color: TEXT, background: WHITE }}>
      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '56px 48px' }}>
        ...
        <Heading>Last Updated 9/12/2025</Heading>

        <p style={P}>
          This Cookie Policy explains how Hair Restoration of Lehigh Valley (&ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;ours&rdquo;) uses cookies and similar technologies to recognize you when you visit our websites at (<a href="https://www.pahairtransplant.com" style={{ color: DARK }}>https://www.pahairtransplant.com</a>). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
        </p>
        <p style={P}>
        ...
        <p style={P}>
          For more information on our data policies, see our <a href="/privacy-policy" style={{ color: DARK }}>Privacy Policy</a>.
        </p>
        <p style={P}>
          If you have any questions about our use of cookies or other technologies, please email us at <a href="mailto:info@pahairtransplant.com" style={{ color: DARK }}>info@pahairtransplant.com</a> or by post to:
        </p>
